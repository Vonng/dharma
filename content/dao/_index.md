...
<div class="cd-reading-note">
  <strong>延伸阅读</strong>
  <p>如果你想按章逐段阅读全文评注，可以继续看 <a href="daodejing/">《道德经》八十一章全文注解</a>。</p>
</div>
...
| **基础设施** | 开放接口、可扩展、可迁移 | 封闭耦合、强锁定、难替换 |
...
| 为学日益，为道日损      | 功能堆叠 vs 重构简化       | 框架越想包办一切，越容易变成负担       |
...
| 道冲而用之或不盈       | 通用基础设施             | 保持核心的“空”，系统才不容易被单一场景填满 |
